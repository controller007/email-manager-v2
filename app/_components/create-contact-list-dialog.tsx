...
const generateId = () => "Contact-" + Math.random().toString(36).substr(2, 7);
...
export function CreateContactListDialog({
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && open) {
      ...
      setDomainId(verifiedDomains.find((d) => d.domain === data)?.id || "");
      setName(generateId());
    }
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new contact list linked to a verified domain. The domain
            determines which sender emails you can use.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {verifiedDomains.length === 0 && (
            <Alert>
              ...
              <AlertDescription>
                <strong>No verified domains available.</strong> You need to add
                and verify a domain before creating contact lists.
              </AlertDescription>
            </Alert>
          )}
          ...
          <div className="space-y-2">
            ...
            {selectedDomain && (
              <p className="text-sm text-gray-500">
                Contact list will use senders from{" "}
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-col justify-between gap-2">
              <p className="text-sm text-gray-500">
                Separate emails with commas, spaces, or new lines. Maximum 100
                emails per list.
              </p>
